...
#ifndef ORDINAL_PRIMITIVES_TEST_SUPPORT_SWIFT_H
#define ORDINAL_PRIMITIVES_TEST_SUPPORT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ordinal_Primitives_Test_Support",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
