...
#ifndef HASH_PRIMITIVES_STANDARD_LIBRARY_INTEGRATION_SWIFT_H
#define HASH_PRIMITIVES_STANDARD_LIBRARY_INTEGRATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hash_Primitives_Standard_Library_Integration",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
