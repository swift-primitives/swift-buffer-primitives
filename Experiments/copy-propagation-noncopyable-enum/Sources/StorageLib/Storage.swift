// StorageLib — Cross-module types for CopyPropagation crash reproduction
...
/// Does NOT clean up elements — owning type is responsible for element lifecycle.
/// Only deallocates the backing buffer on deinit.
